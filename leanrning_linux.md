...
**chmod ugo+rwx filename**     give  permission  to user group othres for  read write execute other equivalents (chmod a+rwx filename ) chmod a=rwx filename, chmod u=rwx,g=rwx,o=rwx filename
