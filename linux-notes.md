...
chmod +x hello.sh       gives make hello.sh executable permission
...
rsync -u   #update
server_destination:      username@ipadress:location (please mind ipadress is separated to 			location with :
   eg camit@pegasus.ac.in:/mnt/home/student/camit/

rysnc -azvP --dru-run   camit@pegasus.ac.in:/mnt/home/student/camit/

rsync -azvP  --include={"*.py","*.dat"}  --exclude "*" /home/amit/Desktop/test_local/ Desktop/tt
				#will include only pythonand dat files excluding all
rsync -azvP   --include={"*/","*.py","*.dat","*.txt"} --exclude="*"   /home/amit/Desktop/test_local/ Desktop/tt/
...
rsync -azvP  --exclude={"*.py","*.dat"}  /home/amit/Desktop/test_local/ Desktop/tt
				#will include only pythonand dat files excluding all
                             or
...
tap archive     just like zip
 tar -cvf                                                                  c  creating archive     v verbose   f filename
  ie to make zip of  test folder     $ tar -cvf  test.tar   test             f need to be used to givefilename

tar -x                       x   extarcting      $ tar -xf test.tar
tar.gz

gz   means gzip               wil craeate zip in   tar.gz file
 
tar -czf                            $ tar -czf test.tar.gz   test             ;remember z need ot come after c
...
grep   -i  “paterntosearchfor”   filename      eg  grep “hello” hello.txt   make case insensitive
 will print lines containing hello 
